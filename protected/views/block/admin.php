...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
			'name'=>'content',
			'type'=>'raw',
			'value'=>'CHtml::encode(substr($data->content,0,250))'
		),
		array(
			'name'=>'dscription',
			'type'=>'raw',
			'value'=>'CHtml::encode(substr($data->dscription,0,250))'
		),
		array(
			'name'=>'sort',
			'type'=>'raw',
		...
		array(
			'name'=>'status',
			'value'=>'Lookup::item("BlockStatus",$data->status)',
			'filter'=>Lookup::items('BlockStatus'),
		),
		array(
			'name'=>'create_time',
			'type'=>'datetime',
